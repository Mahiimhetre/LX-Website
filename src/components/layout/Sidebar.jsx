...
import { LayoutDashboardIcon, UsersIcon, SettingsIcon, CreditCardIcon, LogOutIcon, ChevronLeftIcon, ChevronRightIcon, HomeIcon } from '@/components/icons';
...
const sidebarItems = [
    { icon: LayoutDashboardIcon, label: 'Overview', path: '/dashboard' },
    { icon: UsersIcon, label: 'Team', path: '/team' },
    { icon: CreditCardIcon, label: 'Billing', path: '/pricing' },
    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full">
            ...
            <div className="p-3 border-t border-white/5 space-y-1">
                ...
                >
                    <HomeIcon className="w-5 h-5 group-hover:text-primary transition-colors" />
