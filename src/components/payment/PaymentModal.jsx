                        ...
                        <div className="w-full bg-white/5 p-4 rounded-xl border border-white/10 space-y-3">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button onClick={() => copyToClipboard(paymentDetails?.razorpay_payment_id)} className="p-1 hover:bg-white/10 rounded transition-colors" aria-label="Copy Payment ID">
