...
export async function checkPasswordExpiries() {
    try {
        ...
        // ⚡ Bolt Optimization: Use chunked execution instead of unbounded Promise.all
        // to prevent node process memory spikes and SMTP provider rate limit exhaustion while maintaining performance.
        const chunkSize = 20;
